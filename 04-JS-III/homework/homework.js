...
function incrementarPorUno(array) {
  ...
  // y devuelve el array
  // Tu código:
  var arrayIncrementrado = [];
for (var i = 0; i < array.length; i++){
  arrayIncrementrado.push(array[i]+1)
}
return arrayIncrementrado;
}
...
function breakStatement(numero) {
  ...
  for (var i = 0; i < 10 ; i++){
    ...
    if (suma === i){
      ...
      ArrayGuardar.push(suma);
    }

    }
    if ( ArrayGuardar.length < 10){
      return "Se interrumpió la ejecución";
    }else if(ArrayGuardar.length === 10){
return ArrayGuardar;
    }
